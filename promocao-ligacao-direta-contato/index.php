                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-md-6">
                        <div class="col-md-12 text-center">
                            <img src="<?php echo baseUrl();  ?>images/radios/<?php echo $radio;?>.jpg" alt="<?php echo siteTitle(); ?>" class="img-md-fluid element-animate">
                        </div>
                        <form action="<?php echo baseUrl();  ?>promocao-ligacao-direta-contato/submitform.php" method="post" class="frmcontact">
